...
var require_version = __commonJS({
  "node_modules/@anthropic-ai/sdk/version.js"(exports2) {
    ...
    exports2.VERSION = "0.27.3";
  }
});

// node_modules/@anthropic-ai/sdk/_shims/registry.js
var require_registry = __commonJS({
  "node_modules/@anthropic-ai/sdk/_shims/registry.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", { value: true });
    ...
    function setShims(shims, options = { auto: false }) {
      ...
      if (exports2.kind) {
        throw new Error(`can't \`import '@anthropic-ai/sdk/shims/${shims.kind}'\` after \`import '@anthropic-ai/sdk/shims/${exports2.kind}'\``);
      }
  ...
  "node_modules/web-streams-polyfill/dist/ponyfill.js"(exports2, module2) {
    !function(e, t) {
      ...
      function ce(e2, t2, r2) {
        if ("number" != typeof (o2 = r2) || ie(o2) || o2 < 0 || r2 === 1 / 0)
      ...
      class ReadableStreamBYOBRequest {
        ...
        respond(e2) {
          if (!be(this))
            throw Ae("respond");
          if (M(e2, 1, "respond"), e2 = x(e2, "First parameter"), void 0 === this._associatedReadableByteStreamController)
      ...
      function Ce(e2, t2) {
        ...
        "closed" === e2._controlledReadableByteStream._state ? function(e3, t3) {
          ...
          if (ve(0, t3, r3), "none" === r3.readerType)
      ...
      function kt(e2, t2, r2, o2, n2, a2) {
        ...
        return c((E2, W2) => {
          ...
          }, a2.aborted ? O2() : a2.addEventListener("abort", O2)), Ut(e2) && (v2 = e2._state, s2 = e2._storedError), Xe(t2) && (R2 = t2._state, u2 = t2._storedError, T2 = ot(t2)), Ut(e2) && Xe(t2) && (q2 = true, p2()), "errored" === v2)
            A2(s2);
        ...
        return function(e3) {
          ...
          function g2() {
            l2 && (i2.releaseLock(), i2 = e3.getReader(), y2(i2), l2 = false), h(i2.read(), (e4) => {
              ...
              if (u2 = false, f2 = false, e4.done)
                return b2 || o2.close(), _2 || n2.close(), null === (t4 = o2.byobRequest) || void 0 === t4 || t4.respond(0), null === (r3 = n2.byobRequest) || void 0 === r3 || r3.respond(0), b2 && _2 || a2(void 0), null;
          ...
          function m2() {
            return s2 ? (u2 = true, d(void 0)) : (s2 = true, h(r2.read(), (e4) => {
              if (u2 = false, e4.done)
                return f2 || a2.close(), b2 || i2.close(), f2 && b2 || l2(void 0), null;
              ...
              return function(e4, t5) {
                ...
                if (e4._backpressure) {
                  return m(e4._backpressureChangePromise, () => {
                    if ("erroring" === (Xe(e4._writable) ? e4._writable._state : e4._writableState))
...
var require_MultipartBody = __commonJS({
  "node_modules/@anthropic-ai/sdk/_shims/MultipartBody.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", { value: true });
...
var require_node_runtime = __commonJS({
  "node_modules/@anthropic-ai/sdk/_shims/node-runtime.js"(exports2) {
    "use strict";
    var __createBinding = exports2 && exports2.__createBinding || (Object.create ? function(o, m, k, k2) {
      if (k2 === void 0)
        k2 = k;
...
var require_runtime_node = __commonJS({
  "node_modules/@anthropic-ai/sdk/_shims/auto/runtime-node.js"(exports2) {
    "use strict";
    var __createBinding = exports2 && exports2.__createBinding || (Object.create ? function(o, m, k, k2) {
      if (k2 === void 0)
        k2 = k;
...
var require_shims = __commonJS({
  "node_modules/@anthropic-ai/sdk/_shims/index.js"(exports2) {
...
var require_uploads = __commonJS({
  "node_modules/@anthropic-ai/sdk/uploads.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", { value: true });
...
var require_resource = __commonJS({
  "node_modules/@anthropic-ai/sdk/resource.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", { value: true });
...
var require_PromptCachingBetaMessageStream = __commonJS({
  "node_modules/@anthropic-ai/sdk/lib/PromptCachingBetaMessageStream.js"(exports2) {
    "use strict";
    var __classPrivateFieldSet = exports2 && exports2.__classPrivateFieldSet || function(receiver, state, value, kind, f) {
      if (kind === "m")
        throw new TypeError("Private method is not writable");
    ...
    Object.defineProperty(exports2, "__esModule", { value: true });
    exports2.PromptCachingBetaMessageStream = void 0;
    var error_1 = require_error();
    var streaming_1 = require_streaming();
    ...
    var PromptCachingBetaMessageStream = class _PromptCachingBetaMessageStream {
      ...
      [(_PromptCachingBetaMessageStream_currentMessageSnapshot = /* @__PURE__ */ new WeakMap(), _PromptCachingBetaMessageStream_connectedPromise = /* @__PURE__ */ new WeakMap(), _PromptCachingBetaMessageStream_resolveConnectedPromise = /* @__PURE__ */ new WeakMap(), _PromptCachingBetaMessageStream_rejectConnectedPromise = /* @__PURE__ */ new WeakMap(), _PromptCachingBetaMessageStream_endPromise = /* @__PURE__ */ new WeakMap(), _PromptCachingBetaMessageStream_resolveEndPromise = /* @__PURE__ */ new WeakMap(), _PromptCachingBetaMessageStream_rejectEndPromise = /* @__PURE__ */ new WeakMap(), _PromptCachingBetaMessageStream_listeners = /* @__PURE__ */ new WeakMap(), _PromptCachingBetaMessageStream_ended = /* @__PURE__ */ new WeakMap(), _PromptCachingBetaMessageStream_errored = /* @__PURE__ */ new WeakMap(), _PromptCachingBetaMessageStream_aborted = /* @__PURE__ */ new WeakMap(), _PromptCachingBetaMessageStream_catchingPromiseCreated = /* @__PURE__ */ new WeakMap(), _PromptCachingBetaMessageStream_handleError = /* @__PURE__ */ new WeakMap(), _PromptCachingBetaMessageStream_instances = /* @__PURE__ */ new WeakSet(), _PromptCachingBetaMessageStream_getFinalMessage = function _PromptCachingBetaMessageStream_getFinalMessage2() {
        ...
        if (this.ended)
          return;
        __classPrivateFieldSet(this, _PromptCachingBetaMessageStream_currentMessageSnapshot, void 0, "f");
    ...
    exports2.PromptCachingBetaMessageStream = PromptCachingBetaMessageStream;
  }
});

// node_modules/@anthropic-ai/sdk/resources/beta/prompt-caching/messages.js
var require_messages = __commonJS({
  "node_modules/@anthropic-ai/sdk/resources/beta/prompt-caching/messages.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", { value: true });
    exports2.Messages = void 0;
    var resource_1 = require_resource();
    var PromptCachingBetaMessageStream_1 = require_PromptCachingBetaMessageStream();
    ...
    })(Messages = exports2.Messages || (exports2.Messages = {}));
  }
});

// node_modules/@anthropic-ai/sdk/resources/beta/prompt-caching/prompt-caching.js
var require_prompt_caching = __commonJS({
  "node_modules/@anthropic-ai/sdk/resources/beta/prompt-caching/prompt-caching.js"(exports2) {
    "use strict";
    var __createBinding = exports2 && exports2.__createBinding || (Object.create ? function(o, m, k, k2) {
      if (k2 === void 0)
        k2 = k;
    ...
    Object.defineProperty(exports2, "__esModule", { value: true });
    exports2.PromptCaching = void 0;
    var resource_1 = require_resource();
    var MessagesAPI = __importStar(require_messages());
    var PromptCaching = class extends resource_1.APIResource {
      constructor() {
        super(...arguments);
        this.messages = new MessagesAPI.Messages(this._client);
      }
    };
    exports2.PromptCaching = PromptCaching;
    (function(PromptCaching2) {
      PromptCaching2.Messages = MessagesAPI.Messages;
    })(PromptCaching = exports2.PromptCaching || (exports2.PromptCaching = {}));
  }
});
...
var require_beta = __commonJS({
  "node_modules/@anthropic-ai/sdk/resources/beta/beta.js"(exports2) {
    ...
    var resource_1 = require_resource();
    var PromptCachingAPI = __importStar(require_prompt_caching());
    ...
    exports2.Beta = Beta;
    (function(Beta2) {
      Beta2.PromptCaching = PromptCachingAPI.PromptCaching;
    })(Beta = exports2.Beta || (exports2.Beta = {}));
  }
});
...
var require_completions = __commonJS({
  "node_modules/@anthropic-ai/sdk/resources/completions.js"(exports2) {
    ...
    })(Completions = exports2.Completions || (exports2.Completions = {}));
  }
});
...
var require_messages2 = __commonJS({
  "node_modules/@anthropic-ai/sdk/resources/messages.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", { value: true });
    exports2.Messages = exports2.MessageStream = void 0;
    var resource_1 = require_resource();
    var MessageStream_1 = require_MessageStream();
    var MessageStream_2 = require_MessageStream();
    Object.defineProperty(exports2, "MessageStream", { enumerable: true, get: function() {
...
var require_resources = __commonJS({
  "node_modules/@anthropic-ai/sdk/resources/index.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", { value: true });
    exports2.Messages = exports2.Completions = exports2.Beta = void 0;
...
var require_sdk = __commonJS({
  "node_modules/@anthropic-ai/sdk/index.js"(exports2, module2) {
    ...
    exports2.AnthropicError = Errors.AnthropicError, exports2.APIError = Errors.APIError, exports2.APIConnectionError = Errors.APIConnectionError, exports2.APIConnectionTimeoutError = Errors.APIConnectionTimeoutError, exports2.APIUserAbortError = Errors.APIUserAbortError, exports2.NotFoundError = Errors.NotFoundError, exports2.ConflictError = Errors.ConflictError, exports2.RateLimitError = Errors.RateLimitError, exports2.BadRequestError = Errors.BadRequestError, exports2.AuthenticationError = Errors.AuthenticationError, exports2.InternalServerError = Errors.InternalServerError, exports2.PermissionDeniedError = Errors.PermissionDeniedError, exports2.UnprocessableEntityError = Errors.UnprocessableEntityError;
    exports2.toFile = Uploads.toFile;
    exports2.fileFromPath = Uploads.fileFromPath;
    (function(Anthropic3) {
      Anthropic3.Completions = API.Completions;
      Anthropic3.Messages = API.Messages;
      Anthropic3.Beta = API.Beta;
    })(Anthropic2 = exports2.Anthropic || (exports2.Anthropic = {}));
